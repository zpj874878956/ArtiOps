...
class User(AbstractUser):
    ...
    position = models.CharField(max_length=100, verbose_name=_('职位'), blank=True, default='')
    avatar = models.CharField(max_length=100, verbose_name=_('头像'), blank=True, default='')
